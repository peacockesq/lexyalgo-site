...
export const metadata: Metadata = {
  ...
  description: 'Why LexyAlgo makes divorce and estate-planning tools free: data-driven decisions, cleaner legal workflows, and better outcomes with less acrimony.',
}
      ...
      <section className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
        <div className="prose prose-slate prose-lg max-w-none">
          <div className="space-y-6 text-slate-700 leading-relaxed">
            ...
            <p>
              Because that mission matters more than squeezing people at the worst moment of their lives, nearly all of our tools are entirely free. No catch. If better information can reduce bad settlements, unnecessary conflict, and expensive mistakes, we want it in people&rsquo;s hands sooner.
            </p>
            ...
            <p>
              That&rsquo;s why every trade-off in Asset Divider shows what you <em>gain</em>, not what you lose. Why our calculators show future-value timelines, not just present-value numbers. Why we focus on clean comparisons, less acrimony, and decisions people can actually live with after the paperwork is signed.
            </p>
            ...
            <div className="bg-slate-100 rounded-2xl p-8 my-8 not-prose space-y-3">
              ...
              <p className="text-sm text-slate-500 italic">
                Most LexyAlgo products are still in early alpha or pre-release. We&rsquo;re building in public and shipping quickly to empower users sooner, which means bugs and rough edges should be expected.
              </p>
            </div>
