      ...
      {mobileOpen && (
        <div className="border-t border-slate-100 bg-white px-4 pb-6 pt-2 md:hidden">
          ...
          <div className="mt-3 space-y-1 border-t border-slate-100 pt-3">
            ...
            <Link href="/corpus" onClick={() => setMobileOpen(false)} className="block rounded-xl px-3 py-2.5 text-sm font-medium text-slate-700 hover:bg-slate-50">LexyCorpus</Link>
